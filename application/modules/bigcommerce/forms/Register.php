<?php
	 ...
	 * @version 1.0.2
	 */
	class Bigcommerce_Form_Register extends Zend_Form
	{
		public function init()
		{
			...
			$this->addElement( 'checkbox', 'terms', array ( // TODO lang
				'label' => 'I have read and agreed with <a href="'. $config->plugin->center->baseUrl .'default/index/page/bigcommerce/terms" target="_blank">Terms of use</a>',
				'decorators' => array (
					'ViewHelper',
