<?php
	 ...
	 * @version 1.0.0
	 */
	class Opencart_Form_Register extends Zend_Form
	{
		public function init()
		{
			...
			$this->addElement( 'checkbox', 'terms', array ( // TODO lang
				'label' => 'I have read and agreed with <a href="'. $config->plugin->center->baseUrl .'default/index/page/opencart/terms" target="_blank">Terms of use</a>',
				'decorators' => array (
					'ViewHelper',
