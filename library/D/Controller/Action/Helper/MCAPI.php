<?php
	...
	class D_Controller_Action_Helper_MCAPI extends Zend_Controller_Action_Helper_Abstract
	{
	    var $version = "1.3";
	    ...
	    function __construct() {
           $config = Config::getInstance();
	        $this->api_key = $config->mailchimp->apikey;
	    ...
	    */
	    ...
	    function callServer($method, $params) {
           ...
           if ( $this->errorMessage ) {
               ...
               $logger->error( 'Mail Chimp : ' . $this->errorMessage );
           }
